...
<div id="floor-0" class="row">
    <div id="classify" class="col-sm-3">
        ...
        <ul id="menu">
            ...
            <li class="menu1"><a href="">特色服务</a> <span> > </span>
            </li>
            <li class="menu1"><a href="">合作共赢</a> <span> > </span>
            </li>
            <li class="menu1"><a href="">诚聘英才</a> <span> > </span>
            </li>
            <li class="menu1">新手指南<span> > </span>
            </li>
            <li class="menu1"><a href="">会员注册</a> <span> > </span>
            </li>
            <li class="menu1"><a href="">测试流程</a> <span> > </span>
            </li>
            <li class="menu1"><a href="">支付方式</a> <span> > </span>
            </li>
            <li class="menu1"><a href="">支付方式</a> <span> > </span>
            </li>
            <li class="menu1"><a href="">联系客服</a> <span> > </span>
            </li>
            <li class="menu1">实验室入驻<span> > </span>
            </li>
            <li class="menu1"><a href="">商家注册</a> <span> > </span>
            </li>
            <li class="menu1"><a href="">入驻流程</a> <span> > </span>
            </li>
            <li class="menu1"><a href="">法规规范</a> <span> > </span>
            </li>
            <li class="menu1">售后服务<span> > </span>
            </li>
            <li class="menu1"><a href="">售后条款</a><span> > </span>
            </li>
            <li class="menu1"><a href="">退款流程</a><span> > </span>
            </li>
            <li class="menu1"><a href="">取消订单</a><span> > </span>
            </li>
            <li class="menu1"><a href="">售后客服</a><span> > </span>
            </li>
            <li class="menu1">联系聚仪<span> > </span>
            </li>
            <li class="menu1"><a href="">联系聚仪</a><span> > </span>
            </li>
            <li class="menu1"><a href="">意见建议</a><span> > </span>
            </li>
        </ul>
    </div>
    <!-- classify 左边菜单栏完-->
