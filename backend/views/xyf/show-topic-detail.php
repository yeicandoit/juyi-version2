...
<script type="text/javascript">
    ...
    <!--    循环打印出内容-->
        <style>
            ...
            .nickname{
                padding: 5px;
                text-align: center;
                border-bottom: 1px dashed #7f8c9a;
            }
            .avatar{
                margin: 10px 20px;
            }
    ...
    <?= $form->field($model, 'reply_detail')->widget(\yii\redactor\widgets\Redactor::className(),
        [
            'clientOptions' => [
    ...
    <div class="form-group">
        <?= Html::submitButton('回复该帖', ['ShowTopicDetail'], ['class' => 'btn btn-primary']) ?>
        <input type="button" onClick="location.href='index.php?r=xyf/reedit-topic&id=<?php echo $topic->id; ?>'"
               value="编辑该帖"></td>
        <input type="button" onClick="location.href='index.php?r=xyf/delete-topic&id=<?php echo $topic->id; ?>'"
               value="删除该帖"></td>
    </div>
    <?php ActiveForm::end(); ?>