...
<table>
    ...
    <td style="padding-left: 20px;min-width: 850px; max-width: 1000px;" valign="top">
        ...
        <div align="center" style="height: 36px;background-color: #116fb5">
            <ul id="menu">
                <li><a style='background-color:#bf800c' href="#" onclick="showlab(this, 1)">科研模拟服务</a></li>
                ...
                foreach($model as $k=>$g) { ?>
                    ...
                    <div class='goodshow'>
                        ...
                        <div style="height:130px">
                            ...
                            <div><font size='2'>&nbsp;&nbsp;模拟价格:<?=$g->sell_price?></font></div>
                            <div><font size='1px'>&nbsp;&nbsp;<s>市场价:<?=$g->market_price?></s></font></div>
                        </div>
                    </div>
                    </div>
            <?php }?>
