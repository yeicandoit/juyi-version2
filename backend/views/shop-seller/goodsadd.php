...
JS;
    ...
    <div class="goodInfoBox">
        <?=$form->field($goods, 'brandid')
            ->dropDownList(ArrayHelper::map(backend\models\seller\Brand::find()->where(['type'=>$goods->goodtype])->asArray()->all(),'id','name'), ['style'=>'width:300px', 'prompt'=>'请选择'])?>
    ...
    <br>
    <?=Html::button('下一步', [ 'style' => 'width:100px;', 'class'=>'btn btn-large btn-primary', 'onclick'=>'showDetailInfo()'])?>
    </div>
