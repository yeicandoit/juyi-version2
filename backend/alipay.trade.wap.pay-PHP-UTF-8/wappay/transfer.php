...
require_once dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'buildermodel/AlipayFundTransferContentBuilder.php';
require dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'./../config.php';
if (!empty($_POST['out_biz_no'])&& trim($_POST['out_biz_no'])!=""){
    $out_biz_no = $_POST['out_biz_no'];
    $payee_type = $_POST['payee_type'];
    $payee_account = $_POST['payee_account'];
    $amount  = $_POST['amount'];

    $payRequestBuilder = new AlipayFundTransferContentBuilder();
    $payRequestBuilder->setOutBizNo($out_biz_no);
    $payRequestBuilder->setPayeeType($payee_type);
    $payRequestBuilder->setPayeeAccount($payee_account);
        ...
        <form name=alipayment action='' method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    <dt>转账订单号:</dt>
                    <dd>
                        <input id="out_biz_no" name="out_biz_no" />
                    </dd>
                    <hr class="one_line">
                    <dt>收款账户类型:</dt>
                    <dd>
                        <input id="payee_type" name="payee_type" />
                    </dd>
                    <hr class="one_line">
                    <dt>收款方账户
：</dt>
                    <dd>
                        <input id="payee_account" name="payee_account" />
                    </dd>
                    <hr class="one_line">
                    <dt>转账金额：</dt>
                    <dd>
